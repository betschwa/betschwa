## Hi, I'm Irakli Betchvaia 👋

Senior Software Architect based in Braunschweig, Germany. I am a rational optimist driven by decentralised structures, peer-to-peer networks, and code-centric model-driven engineering. 
...
* **Languages:** Kotlin, Java, Groovy, Swift, C/C++
* **Architecture:** Model-Driven Engineering (MDA, OCL), gRPC, ZeroMQ, Netty, Ktor, Vert.x
* **Data & Tooling:** Enterprise Architect, IntelliJ IDEA, PostgreSQL, Protocol Buffers
